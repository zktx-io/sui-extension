...
# MystenLabs Example: NFT

A minimal NFT that anyone can mint. Demonstrates:
- Basic metadata (name, description, url)
- Event emission on mint
- Transfer, update, and burn helpers

Source: https://github.com/MystenLabs/sui/tree/main/examples/move/nft
`);
...
function files(pkg: string): FileMap {
  return {
    ...
    'sources/testnet_nft.move': `
// Copyright (c) Mysten Labs, Inc.
// SPDX-License-Identifier: Apache-2.0

module ${pkg}::testnet_nft;
...
export const MoveTemplate_Mysten_NFT: MoveTemplate = {
  id: 'mysten_nft',
  label: 'MystenLabs: NFT (testnet)',
  defaultName: 'nft',
  description: 'Simple NFT',
  detail:
    'Mint, transfer, update, burn, and emit event. Adapted for testnet use.',
  files,
};
