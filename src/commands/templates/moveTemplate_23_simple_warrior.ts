...
# MystenLabs Example: Simple Warrior

Wrap/unwrap objects using \`Option\`. Demonstrates:
- A \`Warrior\` that can equip/unequip a \`Sword\`
- Guard rails with custom abort codes
- Minimal test scenarios for expected failures

Source: https://github.com/MystenLabs/sui/tree/main/examples/move/simple_warrior
`);
...
export const MoveTemplate_Mysten_SimpleWarrior: MoveTemplate = {
  id: 'mysten_simple_warrior',
  label: 'MystenLabs: Simple Warrior',
  defaultName: 'simple_warrior',
  description: 'Equip/unequip sword',
  detail:
    'Option-wrapped inventory with equip/unequip and success/failure tests.',
  files,
};
